...
CREATE TABLE "InstagramSession" (
    ...
    CONSTRAINT "InstagramSession_userId_fkey" FOREIGN KEY ("userId") REFERENCES "UserInstagram" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "CookiesFacebook" (
    ...
    CONSTRAINT "CookiesFacebook_userFacebookId_fkey" FOREIGN KEY ("userFacebookId") REFERENCES "UsersFacebook" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CookiesFacebook_userFacebookId_key" ON "CookiesFacebook"("userFacebookId");
