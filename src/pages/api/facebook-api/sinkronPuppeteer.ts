...
export const triggerLoginWithPuppeteer = async (formData: any) => {
    const { id, name, username, password } = formData
    ...
    try {
        ...
        await page.type(selectorLogin.name, username, {delay: 120})
        await new Promise((r) => setTimeout(r, 2000))
        await page.type(selectorLogin.pass, password, {delay: 120})
        await new Promise((r) => setTimeout(r, 2000))
        ...
        const response = await axios.post(`${BASE_URL}/users/update`, beReady)
